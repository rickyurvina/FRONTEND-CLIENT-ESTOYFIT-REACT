        ...
        return (
            <div className={`bts-popup ${open ? 'is-visible' : ''}`} role="alert">
                <div className="bts-popup-container">
                    <h3>Envío a cualquier lugar!</h3>
                    <p>Envío a cualquier lugar para todos los miembros. Para ser un miembro suscribete a nuestro boletin informativo de <strong>ofertas / descuentos.</strong></p>
